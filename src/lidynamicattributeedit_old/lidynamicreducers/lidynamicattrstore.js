...
const convertToFav = (state) => {
    ...
    var curretnValue = String(state.attrValue).toLowerCase();
    ...
    var getUnit = curretnValue.split(/(^\-?\d+\.?\d*|\.\d+)/g); //split the value

    var getStatic = curretnValue.split(' '); //if no units are passed
